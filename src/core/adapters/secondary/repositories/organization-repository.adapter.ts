...
import { type OrganizationalUnitIC, type CampusIC } from '@org/models/controllers/controller-input.model'
import { type InsertCourseOP, type InsertCampusOP, type InsertKnowledgeAreaOP, type FetchCoursetByKnowledgeAreaOP, type InsertCampusCoursesOP } from '@org/ports/organization-output.port'
import { UniqueConstraintError, ValidationError } from 'sequelize'
import { CampusHasCourseModel, CampusModel, CourseModel, OrgUnitModel } from '../orm/sequelize/models'
import { type CampusHasCourseIR, type CourseIR } from '@org/models/repositories/repository-input.model'

...
import { type UpgradeGuestUserToStudentSrvI } from '@auth/services/upgrade-guest-user-to-student.service'
...
export default class UpgradeGuestUserToStudentController implements ControllerInputPort<EmptyResponseModel | never> {
  constructor (
    private readonly service: UpgradeGuestUserToStudentSrvI,

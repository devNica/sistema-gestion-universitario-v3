...
import { accademicOfferSchema, campusRegistrationSchema, courseRegistrationSchema, knowledgedAreaRegistrationSchema } from '@org/application/schemas/organization.schema'

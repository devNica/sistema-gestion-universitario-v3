...
import { type CourseIR, type CampusIR, type KnowledgeAreaIR, type CampusHasCourseIR } from '@org/domain/models/repositories/repository-input.model'
import { type CourseOR } from '@org/domain/models/repositories/repository-output.model'
